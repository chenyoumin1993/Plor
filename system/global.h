...
extern uint64_t total_backoff_cnt;
extern uint64_t total_waiting_cnt;
extern uint64_t total_abort_time;
extern uint64_t total_commit_time;
extern uint64_t total_backoff_time;
extern uint64_t total_waiting_2_commit_time_1;
extern uint64_t total_waiting_2_commit_time_2;
extern uint64_t total_waiting_2_abort_time_1;
extern uint64_t total_waiting_2_abort_time_2;
...
extern uint64_t last_waiting_time_1;
extern uint64_t last_waiting_time_2;
